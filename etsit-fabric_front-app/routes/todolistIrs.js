...
module.exports = [
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                return h.view('todolistIrs', model)
            }
        }
    },

    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                return h.view('todolistIrsView', model)
            }
        }
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                console.log("(setIrs)APPROVED IRS CONTRACT", key, irs, user, creationDate, price);
                ...
                await factory[blockchain].setIrs(key, irs, user, creationDate, price, token)

                pre = 'todolistIrs'
                return h.redirect('/todolistIrs?pre=' + pre)
            }
        }
    }
]
